...
#create_clock -period 16.000 -name rx_tmg_clk -add [get_ports rx0_tmg_n]
#create_clock -period 8.000 -name fe_axi_clk -add [get_pins -hierarchical -filter NAME=~\"*FE_AXI_ACLK*\"]
#create_clock -period 8.000 -name ep_axi_clk -add [get_pins -hierarchical -filter NAME=~\"*EP_AXI_ACLK*\"]
create_clock -period 10.000 -name clk_pl_2 [get_pins {PS8_i/PLCLK[2]}]
create_clock -period 8.000 -name clk_pl_0 [get_pins {PS8_i/PLCLK[0]}]
create_clock -period 40.000 -name clk_pl_1 [get_pins {PS8_i/PLCLK[1]}]
...
create_generated_clock -name ep_clk62p5  [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/pdts_endpoint_inst/pdts_endpoint_inst/rxcdr/mmcm/clku]
create_generated_clock -name ep_clk4x    [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/pdts_endpoint_inst/pdts_endpoint_inst/rxcdr/mmcm/clku4x]
create_generated_clock -name ep_clk2x    [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/pdts_endpoint_inst/pdts_endpoint_inst/rxcdr/mmcm/clku2x]
create_generated_clock -name ep_clkfbout [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/pdts_endpoint_inst/pdts_endpoint_inst/rxcdr/mmcm/clkfb] 

create_generated_clock -name clk500_0        -master_clock ep_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout0]
create_generated_clock -name clock_0         -master_clock ep_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout1]
create_generated_clock -name clk125_0        -master_clock ep_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout2]
create_generated_clock -name mmcm1_clkfbout0 -master_clock ep_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkfbout]

create_generated_clock -name clk500_1        -master_clock local_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout0]
create_generated_clock -name clock_1         -master_clock local_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout1]
create_generated_clock -name clk125_1        -master_clock local_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkout2]
create_generated_clock -name mmcm1_clkfbout1 -master_clock local_clk62p5 [get_nets DAPHNE_V3_F4_1_i/DAPHNE3_0/U0/endpoint_inst/mmcm1_inst/mmcm1_clkfbout]

# define clock groups this is how we tell vivado which clocks are related and which are NOT



set_false_path -from [get_clocks {clk100}] -to [get_clocks {clk_pl_0}]
set_false_path -from [get_clocks {clku}] -to [get_clocks {clk_pl_0}]
...
set_clock_groups -asynchronous -group [get_clocks {clku}] -group [get_clocks {mmcm1_clkout1}]
set_clock_groups -asynchronous -group [get_clocks {mmcm1_clkout0_1}] -group [get_clocks {mmcm1_clkout1}]
set_clock_groups -asynchronous -group [get_clocks {clk_pl_0}] -group [get_clocks {mmcm1_clkout1_1}]
set_clock_groups -asynchronous -group [get_clocks {mmcm1_clkout0}] -group [get_clocks {mmcm1_clkout1_1}]
...
set_clock_groups -asynchronous -group [get_clocks {mmcm1_clkout2_1}] -group [get_clocks {mmcm1_clkout1}]
...
set_property PACKAGE_PIN Y14      [get_ports {MUX_EN[0]}]  ;	     # pin location SOM240_2_A54
set_property PACKAGE_PIN AF13     [get_ports {MUX_EN[1]}]  	;     # pin location SOM240_2_C60
set_property PACKAGE_PIN AG11     [get_ports {MUXA[0]}]  	 ;    # pin location SOM240_2_D50
set_property PACKAGE_PIN AF12     [get_ports {MUXA[1]}]  	  ;   # pin location SOM240_2_D45
...
set_property PACKAGE_PIN E3 [get_ports {FAN_CONTROL[0]}];
set_property IOSTANDARD LVCMOS18 [get_ports {FAN_CONTROL[0]}];
